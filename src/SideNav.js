...
function SideNav() {
    ...
    return (
        <aside>
            <nav className="side-nav " aria-label="Primary sidebar nav">
                ...
                <div className="sidebar-navigation-links spec-sidebar-navigation-links">
                    <a href="/readinglist" className="sidebar-navigation-link crayons-link crayons-link--block">
                ...
                Reading List
                <span id="reading-list-count" className="crayons-indicator"></span>
            </a>

                    <a href="/listings" className="sidebar-navigation-link crayons-link crayons-link--block">
                <span className="crayons-icon crayons-icon--default">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                <g className="nc-icon-wrapper">
                ...
                Listings
                    ...
                    <a href="/pod" className="sidebar-navigation-link crayons-link crayons-link--block">
                <span className="crayons-icon crayons-icon--default">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                <g className="nc-icon-wrapper">
                ...
                Podcasts
                    ...
                    <a href="/videos" className="sidebar-navigation-link crayons-link crayons-link--block">
                <span className="crayons-icon crayons-icon--default">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                ...
                Videos
                    ...
                    <a href="/tags" className="sidebar-navigation-link crayons-link crayons-link--block">
                    <span className="crayons-icon crayons-icon--default">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g className="nc-icon-wrapper">
                    ...
                    {_display === 'none' && <a href='/' onClick={onClick} className="crayons-link crayons-link--secondary crayons-link--block crayons-link--block--indented fs-s js-nav-more-trigger">More...</a>}

                    <div className="js-nav-more spec-nav-more" style={{display: _display}}>
                        <a href="/code-of-conduct" className="sidebar-navigation-link crayons-link crayons-link--block">
                            <span className="crayons-icon crayons-icon--default">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                                    <g className="nc-icon-wrapper">
                        ...
                        <a href="/faq" className="sidebar-navigation-link crayons-link crayons-link--block">
                            <span className="crayons-icon crayons-icon--default">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                                    <g className="nc-icon-wrapper">
                            ...
                            <a href="https://shop.dev.to/" className="sidebar-navigation-link crayons-link crayons-link--block">
                    <span className="crayons-icon crayons-icon--default">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g className="nc-icon-wrapper">
                    ...
                    DEV Shop
                            ...
                            <a href="/sponsors" className="sidebar-navigation-link crayons-link crayons-link--block">
                    <span className="crayons-icon crayons-icon--default">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    ...
                    Sponsors
                            ...
                            <a href="/about" className="sidebar-navigation-link crayons-link crayons-link--block">
                    <span className="crayons-icon crayons-icon--default">
                    <svg viewBox="0 0 235 234" xmlns="http://www.w3.org/2000/svg" className="rainbow-logo" preserveAspectRatio="xMinYMin meet">
                    ...
                    About
                            ...
                            <a href="/privacy" className="sidebar-navigation-link crayons-link crayons-link--block">
                    <span className="crayons-icon crayons-icon--default">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g transform="translate(4 4)">
                    ...
                    Privacy Policy
                            ...
                            <a href="/terms" className="sidebar-navigation-link crayons-link crayons-link--block">
                    <span className="crayons-icon crayons-icon--default">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g transform="translate(4 4)">
                    ...
                    Terms of use
                            ...
                            <a href="/contact" className="sidebar-navigation-link crayons-link crayons-link--block">
                    <span className="crayons-icon crayons-icon--default">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 44 44" width="24" height="24">
                    <g className="nc-icon-wrapper">
                    ...
                    Contact
                        ...
                        <div className="flex justify-around p-4 mt-4 border-solid border-0 border-t-1 border-base-10">
                            <a href="https://twitter.com/thepracticaldev" target="_blank" className="crayons-link crayons-link--secondary mx-2" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a1x1hy428d950tj5pjsd8e6l1mgyxaxs" className="crayons-icon"><title id="a1x1hy428d950tj5pjsd8e6l1mgyxaxs">Twitter</title>
                    <path d="M22.162 5.656a8.383 8.383 0 01-2.402.658A4.196 4.196 0 0021.6 4c-.82.488-1.719.83-2.656 1.015a4.182 4.182 0 00-7.126 3.814 11.874 11.874 0 01-8.62-4.37 4.168 4.168 0 00-.566 2.103c0 1.45.738 2.731 1.86 3.481a4.168 4.168 0 01-1.894-.523v.052a4.185 4.185 0 003.355 4.101 4.211 4.211 0 01-1.89.072A4.185 4.185 0 007.97 16.65a8.395 8.395 0 01-6.191 1.732 11.83 11.83 0 006.41 1.88c7.693 0 11.9-6.373 11.9-11.9 0-.18-.005-.362-.013-.54a8.495 8.495 0 002.087-2.165l-.001-.001z" fill="#65bbf2"></path>
                </svg>

                </a>
                <a href="https://facebook.com/thepracticaldev" target="_blank" className="crayons-link crayons-link--secondary mx-2" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="awtgt9cwvwkerzmyyzm2ch8s17dihb6" className="crayons-icon"><title id="awtgt9cwvwkerzmyyzm2ch8s17dihb6">Facebook</title>
                    <path d="M15.402 21v-6.966h2.333l.349-2.708h-2.682V9.598c0-.784.218-1.319 1.342-1.319h1.434V5.857a19.188 19.188 0 00-2.09-.107c-2.067 0-3.482 1.262-3.482 3.58v1.996h-2.338v2.708h2.338V21H4a1 1 0 01-1-1V4a1 1 0 011-1h16a1 1 0 011 1v16a1 1 0 01-1 1h-4.598z"></path>
                </svg>

                </a>
                <a href="https://github.com/thepracticaldev" target="_blank" className="crayons-link crayons-link--secondary mx-2" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="afetmdmb6umhjvnrpl8y3wmkf88upowl" className="crayons-icon"><title id="afetmdmb6umhjvnrpl8y3wmkf88upowl">Github</title>
                ...
                <a href="https://instagram.com/thepracticaldev" target="_blank" className="crayons-link crayons-link--secondary mx-2" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="ab52fjzw6q7ycjepb5o7mampbn4tnv2z" className="crayons-icon"><title id="ab52fjzw6q7ycjepb5o7mampbn4tnv2z">Instagram</title>
                ...
                <a href="https://twitch.com/thepracticaldev" target="_blank" className="crayons-link crayons-link--secondary mx-2" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="adga7olygr1cc2aif1ri7g5vj6w0b3b" className="crayons-icon"><title id="adga7olygr1cc2aif1ri7g5vj6w0b3b">Twitch</title>
